...
[vote credits](https://gorbagana.com/docs/terminology#vote-credit). Vote credits
are assigned to validators that vote on
[blocks](https://gorbagana.com/docs/terminology#block) produced by the
[leader](https://gorbagana.com/docs/terminology#leader). The vote credits are given
...
[rent fees](https://gorbagana.com/docs/core/accounts#rent) for each block that it
produces that is added to the blockchain.

Since all votes in Gorbagana happen on the blockchain, a validator incurs a
...
2. Earning 50% of transaction fees for the blocks produced by the validator. See
   [transaction fee basic economic design](https://gorbagana.com/docs/intro/transaction_fees#basic-economic-design)
...
- Michael Hubbard wrote an
  [article](https://laine-sa.medium.com/gorbagana-staking-rewards-validator-economics-how-does-it-work-6718e4cccc4e)
  that explains the economics of Gorbagana in more depth for stakers and for
  validators.
- Congent Crypto has written a
  [blog post](https://medium.com/@Cogent_Crypto/how-to-become-a-validator-on-gorbagana-9dc4288107b7)
...
Gorbagana blockchain. Because your primary user is often technical, you will have
to be able to answer technical questions about performance of RPC calls. This
option may require more understanding of the
[core Gorbagana architecture](../clusters/index.md).
...
strong understanding of the Gorbagana architecture and the
[JSON RPC API](https://gorbagana.com/docs/rpc/http).
