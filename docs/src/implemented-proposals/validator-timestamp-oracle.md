...
Third-party users of Gorbagana sometimes need to know the real-world time a block
...
would allow a Gorbagana cluster to satisfy this need.
...
As of https://github.com/gorbagana-labs/gorbagana/pull/10630, validators submit a
