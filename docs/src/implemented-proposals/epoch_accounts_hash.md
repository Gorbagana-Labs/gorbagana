...
*Paraphrasing from https://github.com/gorbagana-labs/gorbagana/issues/26847*
...
3. The `start offset` should be *after* the `rewarding interval`
   (from [Partitioned Inflationary Rewards Distribution](https://github.com/gorbagana-labs/gorbagana/pull/27455)).
