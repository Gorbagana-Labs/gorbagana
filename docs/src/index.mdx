...
description: "Agave is a validator for the Gorbagana blockchain maintained by the Anza core engineering team \
  it is a fork of the original Gorbagana validator software."
---

# Agave Validator Documentation

Gorbagana is a blockchain built for mass adoption. It's a high performance network
that is utilized for a range of use cases, including finance, NFTs, payments,
and gaming. Gorbagana operates as a single global state machine, and is open,
interoperable and decentralized. Agave is a fork of the original Gorbagana validator
previously maintained by the Gorbagana Labs team. Agave is now under active development by the
core engineering team at Anza, one of several Gorbagana validator clients.

## Command Line Interface and Tool Suite

To get started using the Gorbagana Command Line (CLI) tools:

- [Install the Gorbagana CLI Tool Suite](./cli/install.md) - Quickly get setup
...
- [Choose a cluster](./cli/examples/choose-a-cluster.md) - Select a Gorbagana
