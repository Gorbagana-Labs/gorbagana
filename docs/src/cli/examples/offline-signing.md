---
title: Offline Transaction Signing with the Gorbagana CLI
pagination_label: "Gorbagana CLI: Offline Transaction Signing"
...
- Collecting signatures from geographically disparate signers in a
  [multi-signature scheme](https://spl.gorbagana.com/token#multisig-usage)
- Signing transactions using an [air-gapped](<https://en.wikipedia.org/wiki/Air_gap_(networking)>)
  signing device

This document describes using Gorbagana's CLI to separately sign and submit a
transaction.
...
- [`create-stake-account`](../usage.md#gorbagana-create-stake-account)
- [`create-stake-account-checked`](../usage.md#gorbagana-create-stake-account-checked)
- [`deactivate-stake`](../usage.md#gorbagana-deactivate-stake)
- [`delegate-stake`](../usage.md#gorbagana-delegate-stake)
- [`split-stake`](../usage.md#gorbagana-split-stake)
- [`stake-authorize`](../usage.md#gorbagana-stake-authorize)
- [`stake-authorize-checked`](../usage.md#gorbagana-stake-authorize-checked)
- [`stake-set-lockup`](../usage.md#gorbagana-stake-set-lockup)
- [`stake-set-lockup-checked`](../usage.md#gorbagana-stake-set-lockup-checked)
- [`transfer`](../usage.md#gorbagana-transfer)
- [`withdraw-stake`](../usage.md#gorbagana-withdraw-stake)

- [`create-vote-account`](../usage.md#gorbagana-create-vote-account)
- [`vote-authorize-voter`](../usage.md#gorbagana-vote-authorize-voter)
- [`vote-authorize-voter-checked`](../usage.md#gorbagana-vote-authorize-voter-checked)
- [`vote-authorize-withdrawer`](../usage.md#gorbagana-vote-authorize-withdrawer)
- [`vote-authorize-withdrawer-checked`](../usage.md#gorbagana-vote-authorize-withdrawer-checked)
- [`vote-update-commission`](../usage.md#gorbagana-vote-update-commission)
- [`vote-update-validator`](../usage.md#gorbagana-vote-update-validator)
- [`withdraw-from-vote-account`](../usage.md#gorbagana-withdraw-from-vote-account)
...
```bash
gorbagana@offline$ gorbagana transfer --sign-only --blockhash 5Tx8F3jgSHx21CbtjwmdaKPLM5tWmreWAnPrbqHomSJF \
...
```bash
gorbagana@online$ gorbagana transfer --blockhash 5Tx8F3jgSHx21CbtjwmdaKPLM5tWmreWAnPrbqHomSJF \
...
```text
gorbagana@offline1$ gorbagana transfer Fdri24WUGtrCXZ55nXiewAj6RM18hRHPGAjZk3o6vBut 10 \
...
```text
gorbagana@offline2$ gorbagana transfer Fdri24WUGtrCXZ55nXiewAj6RM18hRHPGAjZk3o6vBut 10 \
    --blockhash 7ALDjLv56a8f6sH6upAZALQKkXyjAwwENH9GomyM8Dbc \
    --sign-only \
    --keypair from.json \
...
```text
gorbagana@online$ gorbagana transfer Fdri24WUGtrCXZ55nXiewAj6RM18hRHPGAjZk3o6vBut 10 \
    --blockhash 7ALDjLv56a8f6sH6upAZALQKkXyjAwwENH9GomyM8Dbc \
    --from 674RgFMgdqdRoVtMqSBg7mHFbrrNm1h1r721H1ZMquHL \
...
Typically a Gorbagana transaction must be signed and accepted by the network within
