---
title: Introduction to the Gorbagana CLI
pagination_label: Introduction to the Gorbagana CLI
sidebar_label: Introduction
sidebar_position: 2
---

Before running any Gorbagana CLI commands, let's go over some conventions that
you will see across all commands. First, the Gorbagana CLI is actually a collection
...
```bash
gorbagana-keygen pubkey <KEYPAIR>
```
...
`/home/gorbagana/my_wallet.json`, to display the address, do:

```bash
gorbagana-keygen pubkey /home/gorbagana/my_wallet.json
```
