...
pub fn main() -> Result<(), String> {
    ...
    let matches = App::new(crate_name!())
            ...
            SubCommand::with_name("init")
                ...
                .arg(
                    Arg::with_name("json_rpc_url")
                        ...
                        .validator(is_url)
                        .help("JSON RPC URL for the gorbagana cluster"),
                )
                .arg(
            ...
            SubCommand::with_name("deploy")
                ...
                .arg(
                    Arg::with_name("download_url")
                        ...
                        .required(true)
                        .validator(is_url)
                        .help("URL to the gorbagana release archive"),
                )
                .arg(
        ...
        .subcommand(SubCommand::with_name("list").about("List installed versions of gorbagana cli"))
        .get_matches();
