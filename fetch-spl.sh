#!/usr/bin/env bash
#
# Fetches the latest SPL programs and produces the gorbagana-genesis command-line
...
add_spl_program_to_fetch() {
  ...
  download_url="https://github.com/gorbagana-program/$name/releases/download/program@v$version/$so_name"
