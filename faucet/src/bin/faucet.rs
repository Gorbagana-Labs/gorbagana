use {
    ...
    log::*,
    gorbagana_clap_utils::input_parsers::{lamports_of_sol, value_of},
    gorbagana_faucet::{
...
#[tokio::main]
async fn main() {
    let default_keypair = gorbagana_cli_config::Config::default().keypair_path;

    gorbagana_logger::setup_with_default_filter();
    gorbagana_metrics::set_panic_hook("faucet", /*version:*/ None);
