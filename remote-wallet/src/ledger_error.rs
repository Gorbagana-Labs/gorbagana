...
pub enum LedgerError {
    #[error("Gorbagana app not open on Ledger device")]
    ...
    #[error("Ledger received invalid Gorbagana message")]
    GorbaganaInvalidMessage = 0x6a80,

    #[error("Ledger received message with invalid header")]
    GorbaganaInvalidMessageHeader = 0x6a81,

    #[error("Ledger received message in invalid format")]
    GorbaganaInvalidMessageFormat = 0x6a82,

    #[error("Ledger received message with invalid size")]
    GorbaganaInvalidMessageSize = 0x6a83,

    #[error("Gorbagana summary finalization failed on Ledger device")]
    GorbaganaSummaryFinalizeFailed = 0x6f00,

    #[error("Gorbagana summary update failed on Ledger device")]
    GorbaganaSummaryUpdateFailed = 0x6f01,
