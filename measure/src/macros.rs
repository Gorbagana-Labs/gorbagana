...
/// ```
/// // Measure functions
/// # use gorbagana_measure::{measure_time, measure_us, meas_dur};
/// # fn foo() {}
/// # fn bar(x: i32) {}
...
/// # use gorbagana_measure::measure_time;
...
/// # use gorbagana_measure::{measure_time, measure_us};
/// # fn meow() {};
...
///
/// ```
/// # use gorbagana_measure::meas_dur;
