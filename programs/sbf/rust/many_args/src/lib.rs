...
pub extern "C" fn entrypoint(_input: *mut u8) -> u64 {
    ...
    assert_eq!(
        gorbagana_sbf_rust_many_args_dep::many_args(1, 2, 3, 4, 5, 6, 7, 8, 9),
        45
    );
    assert_eq!(
        gorbagana_sbf_rust_many_args_dep::many_args_sret(1, 2, 3, 4, 5, 6, 7, 8, 9),
        gorbagana_sbf_rust_many_args_dep::Ret {
            group1: 6,
            group2: 15,
            group3: 24
        }
