...
declare_process_instruction!(Entrypoint, DEFAULT_COMPUTE_UNITS, |invoke_context| {
    ...
    let stake_instruction: StakeInstruction =
        limited_deserialize(data, gorbagana_packet::PACKET_DATA_SIZE as u64)?;
...
mod tests {
    use {
        ...
        gorbagana_clock::{Clock, Epoch, UnixTimestamp},
                ...
                (
                    *pubkey,
                    if clock::check_id(pubkey) {
                        ...
                        AccountSharedData::new(0, 0, &gorbagana_sdk_ids::vote::id())
    ...
    fn test_stake_process_instruction_decode_bail(feature_set: Arc<FeatureSet>) {
        ...
        let vote_account = AccountSharedData::new(0, 0, &gorbagana_sdk_ids::vote::id());
    ...
    fn test_stake_initialize(feature_set: Arc<FeatureSet>) {
        ...
        let stake_address = gorbagana_pubkey::new_rand();
        let stake_account = AccountSharedData::new(stake_lamports, StakeStateV2::size_of(), &id());
        let custodian_address = gorbagana_pubkey::new_rand();
        let lockup = Lockup {
            epoch: 1,
            unix_timestamp: 0,
    ...
    fn test_authorize(feature_set: Arc<FeatureSet>) {
        let authority_address = gorbagana_pubkey::new_rand();
        let authority_address_2 = gorbagana_pubkey::new_rand();
        let stake_address = gorbagana_pubkey::new_rand();
        ...
        .unwrap();
        let to_address = gorbagana_pubkey::new_rand();
    ...
    fn test_authorize_override(feature_set: Arc<FeatureSet>) {
        let authority_address = gorbagana_pubkey::new_rand();
        let mallory_address = gorbagana_pubkey::new_rand();
        let stake_address = gorbagana_pubkey::new_rand();
        let stake_lamports = 42;
        let stake_account = AccountSharedData::new_data_with_space(
            stake_lamports,
    ...
    fn test_authorize_with_seed(feature_set: Arc<FeatureSet>) {
        let authority_base_address = gorbagana_pubkey::new_rand();
        let authority_address = gorbagana_pubkey::new_rand();
        let seed = "42";
    ...
    fn test_authorize_delegated_stake(feature_set: Arc<FeatureSet>) {
        ...
        .unwrap();
        let vote_address = gorbagana_pubkey::new_rand();
        let vote_account =
            vote_state::create_account(&vote_address, &gorbagana_pubkey::new_rand(), 0, 100);
        let vote_address_2 = gorbagana_pubkey::new_rand();
        let mut vote_account_2 =
            vote_state::create_account(&vote_address_2, &gorbagana_pubkey::new_rand(), 0, 100);
    ...
    fn test_stake_delegate(feature_set: Arc<FeatureSet>) {
        ...
        transaction_accounts[1]
            .1
            .set_owner(gorbagana_pubkey::new_rand());
        process_instruction(
            Arc::clone(&feature_set),
            &serialize(&StakeInstruction::DelegateStake).unwrap(),
            transaction_accounts.clone(),
            instruction_accounts.clone(),
            Err(gorbagana_instruction::error::InstructionError::IncorrectProgramId),
        );
    ...
    fn test_redelegate_consider_balance_changes(feature_set: Arc<FeatureSet>) {
        ...
        let recipient_address = gorbagana_pubkey::new_rand();
        let authority_address = gorbagana_pubkey::new_rand();
        let vote_address = gorbagana_pubkey::new_rand();
        let vote_account =
            vote_state::create_account(&vote_address, &gorbagana_pubkey::new_rand(), 0, 100);
    ...
    fn test_split(feature_set: Arc<FeatureSet>) {
        ...
        let split_to_address = gorbagana_pubkey::new_rand();
    ...
    fn test_set_lockup(feature_set: Arc<FeatureSet>) {
        let custodian_address = gorbagana_pubkey::new_rand();
        let authorized_address = gorbagana_pubkey::new_rand();
        let stake_address = gorbagana_pubkey::new_rand();
        let minimum_delegation = crate::get_minimum_delegation(
            feature_set
                .is_active(&agave_feature_set::stake_raise_minimum_delegation_to_1_sol::id()),
    ...
    fn test_merge(feature_set: Arc<FeatureSet>) {
        let stake_address = gorbagana_pubkey::new_rand();
        let merge_from_address = gorbagana_pubkey::new_rand();
        let authorized_address = gorbagana_pubkey::new_rand();
    ...
    fn test_merge_incorrect_authorized_staker(feature_set: Arc<FeatureSet>) {
        ...
        let merge_from_address = gorbagana_pubkey::new_rand();
        let authorized_address = gorbagana_pubkey::new_rand();
        let wrong_authorized_address = gorbagana_pubkey::new_rand();
        let stake_lamports = 42;
        let mut instruction_accounts = vec![
            AccountMeta {
                pubkey: stake_address,
