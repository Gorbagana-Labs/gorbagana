...
pub(crate) const MIN_STAKE_FOR_GOSSIP: u64 = gorbagana_native_token::LAMPORTS_PER_SOL;
/// Minimum stake required for a node to bypass the initial ping check when joining gossip.
pub(crate) const MIN_STAKE_TO_SKIP_PING: u64 = 1000 * gorbagana_native_token::LAMPORTS_PER_SOL;
