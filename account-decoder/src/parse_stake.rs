use {
    ...
    bincode::deserialize,
    gorbagana_clock::{Epoch, UnixTimestamp},
    gorbagana_stake_interface::state::{Authorized, Delegation, Lockup, Meta, Stake, StakeStateV2},
};
...
pub struct UiDelegation {
    ...
    #[deprecated(
        since = "1.16.7",
        note = "Please use `gorbagana_stake_interface::state::warmup_cooldown_rate()` instead"
    )]
...
#[cfg(test)]
mod test {
    use {super::*, bincode::serialize, gorbagana_stake_interface::stake_flags::StakeFlags};
