use {
    ...
    gorbagana_clap_utils::{self, hidden_unless_forced, input_validators::*, keypair::*},
    gorbagana_cli_config::CONFIG_FILE,
};
    ...
    App::new(name)
        ...
        .subcommand(
            SubCommand::with_name("config")
                .about("Gorbagana command-line tool configuration settings")
                .aliases(&["get", "set"])
                .setting(AppSettings::SubcommandRequiredElseHelp)
                .subcommand(
