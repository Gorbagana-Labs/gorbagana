...
#[allow(deprecated)]
use gorbagana_sysvar::recent_blockhashes::{IntoIterSorted, IterItem, RecentBlockhashes, MAX_ENTRIES};
use {
    gorbagana_account::{
...
mod tests {
    ...
    use {
        ...
        gorbagana_account::{from_account, DUMMY_INHERITABLE_ACCOUNT_FIELDS},
        gorbagana_hash::{Hash, HASH_BYTES},
        gorbagana_sysvar::recent_blockhashes::Entry,
    };
